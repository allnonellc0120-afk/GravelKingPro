  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <motion.div
          className="absolute bg-[#ff3a1a] rounded-full blur-[150px] mix-blend-screen"
          animate={{
            x: ['-20vw', '40vw', '90vw', '10vw', '-20vw'][currentScene % 5],
            y: ['10vh', '50vh', '-10vh', '60vh', '10vh'][currentScene % 5],
            scale: [1, 1.2, 0.8, 1.1, 1][currentScene % 5],
            opacity: [0.03, 0.08, 0.03, 0.05, 0.03][currentScene % 5],
          }}
          transition={{ duration: 6, ease: [0.25, 0.1, 0.25, 1] }}
          style={{ width: '60vw', height: '60vw' }}
        />
        <motion.div
          className="absolute bg-[#ffffff] rounded-full blur-[120px] mix-blend-overlay"
          animate={{
            x: ['80vw', '20vw', '-10vw', '50vw', '80vw'][currentScene % 5],
            y: ['70vh', '20vh', '40vh', '-10vh', '70vh'][currentScene % 5],
            scale: [0.6, 1.5, 0.9, 1.2, 0.6][currentScene % 5],
            opacity: [0.02, 0.04, 0.02, 0.03, 0.02][currentScene % 5],
          }}
