...
// The component preview service may already own 8081 in the workspace. Keep
// the build's Metro port configurable so local builds and artifact publishing
// can avoid that unrelated service without changing bundle behavior.
...
async function selectMetroPort() {
  // In the workspace, the component-preview service commonly owns 8081.
  // Deployment still uses 8081 unless it is already occupied.
  while (!(await portIsAvailable(metroPort))) {
    metroPort += 1;
  }
