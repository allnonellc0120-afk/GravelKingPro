...
async function buildTest() {
  ...
  await esbuild({
    entryPoints: [
      ...
      path.resolve(artifactDir, "src/__tests__/email-capture.test.ts"),
      path.resolve(artifactDir, "src/__tests__/generation-pipeline.test.ts"),
      path.resolve(artifactDir, "src/__tests__/generation-pipeline-fallback.test.ts"),
      ...
      path.resolve(artifactDir, "src/__tests__/commercial-fingerprint.test.ts"),
      ...
      path.resolve(artifactDir, "src/__tests__/credits.test.ts"),
      ...
      path.resolve(artifactDir, "src/__tests__/telemetry-reports.test.ts"),
      path.resolve(artifactDir, "src/__tests__/duet-timeout.test.ts"),
      path.resolve(artifactDir, "src/__tests__/stripe-backfill.test.ts"),
      path.resolve(artifactDir, "src/__tests__/news-proxy.test.ts"),
    ],
    platform: "node",
    bundle: true,
    format: "esm",
