...
/**
 * King and Node Auditor subscribers receive 20 included certificate unlocks
 * per rolling 30-day window. Pro and Free subscribers get no included
 * allowance, but may always buy an individual permanent unlock for $1.99.
 *
 * The consume path mirrors lib/exportQuota.ts: reset-or-increment is decided
