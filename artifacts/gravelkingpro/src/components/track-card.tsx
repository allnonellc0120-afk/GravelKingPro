    ...
    <Card className="border-border/40 bg-card/40 overflow-hidden group">
      <div className="relative aspect-square bg-secondary/20 overflow-hidden">
        ...
        <button
          ...
          className="audio-reactive absolute bottom-2 right-2 w-11 h-11 rounded-full bg-amber-500 text-black flex items-center justify-center shadow-lg hover:bg-amber-400 transition-colors"
          data-audio-active={playing}
          style={{
            "--audio-ring": playing ? "5px" : "0px",
            "--audio-ring-wide": playing ? "8px" : "0px",
            "--audio-opacity": playing ? "0.45" : "0",
            "--audio-secondary-opacity": playing ? "0.22" : "0",
