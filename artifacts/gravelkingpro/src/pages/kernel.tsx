        ...
        <div className="max-w-lg mx-auto mt-20 text-center space-y-6">
          ...
          <div className="grid grid-cols-1 gap-3 text-left">
            {[
              ...
              <div key={f} className="flex items-center gap-2.5 px-4 py-2.5 rounded-lg bg-secondary/30 border border-border/30 text-sm">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-muted-foreground text-sm">GravelKing Kernel — MLK v2 amplitude carving engine.</p>
          </div>
