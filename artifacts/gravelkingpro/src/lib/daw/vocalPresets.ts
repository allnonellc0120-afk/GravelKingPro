...
export const VOCAL_PRESETS: VocalPreset[] = [
  ...
  },
  {
    ...
    lowGain: 3, midGain: 0, highGain: -1,
    compThreshold: -22, compRatio: 2.5,
    reverbMix: 0.06, echoDelay: 0, echoMix: 0,
  },
  {
    ...
    reverbMix: 0.04, echoDelay: 0, echoMix: 0,
  },
  {
    id: "space", label: "Space", emoji: "🌌",
    description: "Airy reverb + air EQ boost",
    accent: "#8b5cf6", glow: "rgba(139,92,246,0.2)", bg: "linear-gradient(135deg,#2e1065,#13043a)",
    lowGain: 0, midGain: 0, highGain: 2,
    compThreshold: -20, compRatio: 2.5,
    reverbMix: 0.35, echoDelay: 0, echoMix: 0,
  },
  {
    ...
    compThreshold: -20, compRatio: 2.5,
    reverbMix: 0.25, echoDelay: 0.22, echoMix: 0.30,
  },
  {
    ...
    lowGain: 1, midGain: -1, highGain: 3,
    compThreshold: -16, compRatio: 5,
    reverbMix: 0.10, echoDelay: 0, echoMix: 0,
  },
];
