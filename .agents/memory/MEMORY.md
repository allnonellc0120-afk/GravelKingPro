...
- [Lifetime access grant + activation](lifetime-access.md) — set is_pro=true + subscription_tier='node_auditor' on users row; pre-registered rows need /api/activate?t=<uuid> claim link or they stay disconnected from any real session
