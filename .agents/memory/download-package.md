...
- Paid online features (connect to gravelkingpro.com): Full mastering download, Voice Removal, Stem Splitting, full Beat Maker, Mix Studio, Kernel Dashboard
...
**Why:** User wants the product listed on gravelkingpro.com as a downloadable product. The free tier runs locally, paid routes to their hosted API. This is honest about the architecture — it's not a standalone offline app, it's a self-hosted version with upgrade path.
